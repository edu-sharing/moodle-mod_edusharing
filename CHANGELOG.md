...
- Removed redundant capability check from ticket AJAX endpoint. Students can now switch to edu-sharing with the block plugin.

### Added

- Build Routine in CI-Pipeline

## [11.0.2] - 2026-07-30

### Fixed

- Error when creating activity or Editor using the edu-sharing plugin.
- Grading feature for edu-sharing H5P content is now available with deactivated completion tracking

## [11.0.1] - 2026-07-09

### Fixed

- JavaScript error in activity embedding form
...
- Grading feature for ES H5P activities
- improved tracking for ES activities
- New activity view for ES activities (only Rendering Service 2)
...
- Back button in plugin registration and metadata import forms

### Fixed

- Missing ticket check now leads to a proper error message instead of a cryptic error message

## [10.3.1] - 2026-02-23

### Fixed

- Fixed type error in observer which led to a fatal error on course restoration

## [10.3.0] - 2026-02-20

### Added

- Capability to detect embedded EduSharing widgets in editor markup.

### Fixed

- Asynchronous course restoration and duplication now uses the triggering user instead of the admin for authentication against Edu-Sharing.

## [10.2.3] - 2026-01-30

### Changed

- Refactored code for IDP functionality

## [10.2.2] - 2026-01-26

### Fixed

- Missing class EduSharingApiClient\\PreviewSize added to eduSharingAutoloader.php

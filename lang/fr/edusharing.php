...
$string['modulename'] = 'objet edu-sharing';
...
$string['allow_registration_over_http'] = 'Autoriser l\'enregistrement du dépôt via HTTP';
$string['allow_registration_over_http_help'] = 'Cette option permet d\'effectuer l\'enregistrement du dépôt via HTTP non sécurisé. Elle ne doit être utilisée qu\'à des fins de développement et de test.';
$string['use_service_worker'] = 'Utiliser le service worker de rendu';
$string['use_service_worker_help'] = 'Si activé, un service worker est enregistré pour prendre en charge le rendu des contenus Edu-Sharing. Désactivé par défaut.';
